...
```json
{
  ...
  "attempts": [
    {
      "artifacts": [],
      "attempt_id": "attempt:um-num-019-four-exponentials-conjecture-f5a6643c-source-fidelity-01",
      "claims": [],
      "completed_at": null,
      "generator": "trusted-rolling-source-admission-v1",
      "inputs": [
        "problem-library/records/canonical-problems.jsonl",
        "https://www.unsolvedmath.com/problems/NUM-019"
      ],
      "lifecycle": "planned",
      "method": "discovery",
      "objective": "Close the source-fidelity obligation before attempting the frozen root statement.",
      "obligation_graph_id": "graph:um-num-019-four-exponentials-conjecture-f5a6643c-v1",
      "problem_contract_sha256": "8e2664b3759afb36627a92e186e7ac38032be44bb31242b389635c18665e76d3",
      "problem_id": "problem:um-num-019-four-exponentials-conjecture-f5a6643c",
      "route_id": "route:um-num-019-four-exponentials-conjecture-f5a6643c-source-fidelity",
  ...
  "obligation_graphs": [
    {
      "attempt_id": "attempt:um-num-019-four-exponentials-conjecture-f5a6643c-source-fidelity-01",
      "graph_id": "graph:um-num-019-four-exponentials-conjecture-f5a6643c-v1",
      "obligations": [
        {
          "dependencies": [
            "obligation:um-num-019-four-exponentials-conjecture-f5a6643c-statement-fidelity"
          ],
          "kind": "root_claim",
          "obligation_id": "obligation:um-num-019-four-exponentials-conjecture-f5a6643c-root",
          "statement": {
            "formal_declaration": null,
            "language": "en",
            "text": "If x₁,x₂ and y₁,y₂ are linearly independent over ℚ, is at least one of e^(xᵢyⱼ) transcendental?"
          },
          "statement_sha256": "848edd43930d15b38e2412029ed4e3ff7317fba6bb22b4e380c315700bfe6d23"
        },
        {
          "dependencies": [],
          "kind": "definition",
          "obligation_id": "obligation:um-num-019-four-exponentials-conjecture-f5a6643c-statement-fidelity",
          "statement": {
            "formal_declaration": null,
            "language": "en",
      ...
      "root_obligation_id": "obligation:um-num-019-four-exponentials-conjecture-f5a6643c-root",
      "route_id": "route:um-num-019-four-exponentials-conjecture-f5a6643c-source-fidelity"
    }
  ],
  "problem_contract": {
    ...
    "sources": [
      {
        ...
        "source_record_id": "unsolvedmath-num-019-72be66356a23",
        "url": "https://www.unsolvedmath.com/problems/NUM-019"
      },
      {
        "retrieved_at": "2026-09-02T00:06:43Z",
